...
const AdminDashboard = () => {
  ...
  const { stats, revenueData, tourPopularity, recentBookings } = useMemo(() => {
    ...
    const stats = [
      ...
      { label: "LTV da Base", value: customerCount > 0 ? fmt(revenueData.reduce((s, d) => s + d.revenue, 0) / customerCount) : "R$ 0", change: `${customerCount} clientes`, up: true, icon: Users, path: "/admin/crm" },
    ];
