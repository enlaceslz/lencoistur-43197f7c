...
import { Plus, Loader2, Pencil, Trash2, Calendar, Tag, User, AlertCircle, CheckCircle2, Printer, Search, FileText, Upload, X, ExternalLink, Save, XCircle, Link2 } from "lucide-react";
