      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-foreground">Contas a Pagar</h3>
          ...
          {contas.length === 0 ? (
            <p className="text-muted-foreground text-center py-10">Nenhuma conta a pagar cadastrada.</p>
          ) : (
                ...
                <tbody>
                  {contas.map((c) => (
                    <tr key={c.id} className="border-b border-border last:border-0 hover:bg-muted/50">
                      ...
                      <td className="py-3 text-muted-foreground">{c.fornecedor || "—"}</td>
