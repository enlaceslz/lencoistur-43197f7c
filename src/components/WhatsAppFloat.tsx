...
const smartMessages = [
  "🏖️ Descubra os Lençóis Maranhenses!",
  "🔥 Passeios com até 15% OFF!",
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      {showBubble && !dismissed && (
        <div className="relative bg-card border border-border rounded-2xl shadow-xl p-4 max-w-[260px] animate-in slide-in-from-bottom-4 fade-in duration-500">
          ...
          >
            <MessageSquare size={14} /> Falar agora
          </a>
        </div>
      )}
      ...
      >
        ...
        {!dismissed && (
          <span className="absolute -top-1 -right-1 w-5 h-5 bg-destructive rounded-full flex items-center justify-center text-[10px] font-bold text-destructive-foreground animate-pulse">
            1
          </span>
        )}
      </a>
